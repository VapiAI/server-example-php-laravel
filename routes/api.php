...
Route::middleware('api')->group(function () {
    ...
    Route::post('/custom-llm/basic/chat/completions', [CustomLLMController::class, 'create_basic']);
    Route::post('/custom-llm/openai-sse/chat/completions', [CustomLLMController::class, 'create_openai_sse']);
    Route::post('/custom-llm/openai-advanced/chat/completions', [CustomLLMController::class, 'create_openai_advanced']);
